...
<nav class="flex justify-between items-center bg-gray-800 text-white p-4">
  <div>
    <a href="/" on:click={() => navigate('/')} class="mr-4">Home</a>
    <a href="/dashboard kelas" on:click={() => navigate('/dashboard kelas')} class="mr-4">Dashboard</a>
    <a href="/send" on:click={() => navigate('/send')} class="mr-4">Kirim</a>
